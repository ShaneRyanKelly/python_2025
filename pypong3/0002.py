...
pygame.display.set_caption("Pong with Ball Collisions")
...
def main():
    ...
    while running:
        ...
        for i, ball in enumerate(balls_to_process):
            ...
            # Move ball and handle ceiling/floor
            ...
            if new_rect.top <= 0:
                ...
                ball.dy = max(abs(ball.dy) * 0.9, SPEEDS['BALL_BASE_Y'])  # Ensure minimum speed
                ball.spin *= 0.8
