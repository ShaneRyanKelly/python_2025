...
BOOST_SPEED = 8
STAMINA_MAX = 100
STAMINA_DRAIN = 0.5  # Stamina drain per frame when boosting
STAMINA_REGEN = 0.2  # Stamina regen per frame when not boosting
...
while running:
    ...
    # Draw stamina bars
    player_stamina_bar = pygame.Rect(WIDTH - 30, 50, 10, 100)
    opponent_stamina_bar = pygame.Rect(20, 50, 10, 100)
    pygame.draw.rect(screen, RED, player_stamina_bar)
    pygame.draw.rect(screen, RED, opponent_stamina_bar)
    pygame.draw.rect(screen, GREEN, (WIDTH - 30, 50 + 100 - (player_stamina), 10, player_stamina))
    pygame.draw.rect(screen, GREEN, (20, 50 + 100 - (opponent_stamina), 10, opponent_stamina))
