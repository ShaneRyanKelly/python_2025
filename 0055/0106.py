...
storm_dates = ['2021-02-01', '2020-12-16', '2020-08-04', '2020-12-17', '2020-12-17']
wspd_values = [17.92, 18.19, 18.69, 17.09, 15.58]
wvht_values = [5.35, 5.20, 4.46, 5.26, 6.24]
...
plt.title('Comparison of Top 5 Storms by Wind Speed and Wave Height')
plt.tight_layout()
plt.show()
...
wave_heights = [4.984226, 5.990418, 6.937423, 8.121179, 9.423310]

plt.figure(figsize=(10, 6))
plt.bar(categories, wave_heights, color='teal', alpha=0.7)
plt.xlabel('Hurricane Category')
plt.ylabel('Predicted Wave Height (m)')
plt.title('Predicted Wave Height by Hurricane Category')
plt.tight_layout()
plt.show()