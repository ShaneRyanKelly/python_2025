...
monthly_by_year = monthly_by_year.drop(columns=[2024], level=0)

plt.figure(figsize=(12, 6))
for year in monthly_by_year.columns:
    plt.plot(monthly_by_year.index, monthly_by_year[year], marker='o', label=f'Year {year}')
...
print("Note: 2024 includes predicted values for Jan-Mar and Oct-Dec.")
